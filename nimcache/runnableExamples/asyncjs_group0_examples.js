...
function arrayConstr(len_33557336, value_33557337, typ_33557338) {
        var result = new Array(len_33557336);
    for (var i = 0; i < len_33557336; ++i) result[i] = nimCopy(null, value_33557337, typ_33557338);
    return result;
...
function raiseException(e_33556675, ename_33556676) {
    ...
    e_33556675.trace = nimCopy(null, rawWriteStackTrace_33556626(), NTI33554449);
    throw e_33556675;
...
function auxWriteStackTrace_33556530(f_33556531) {
  var result_33556532 = [[]];
    ...
    var tempFrames_33556543 = arrayConstr(64, {Field0: null, Field1: 0, Field2: null}, NTI33555841);
    Label1: {
        Label2: while (true) {
    ...
    result_33556532[0].push.apply(result_33556532[0], HEX24_369098760((total_33556542 - i_33556541)));;
    ...
    Label5: {
      ...
      Label6: {
          ...
          if (!(0 <= res_973078638)) break Label7;
            ...
            result_33556532[0].push.apply(result_33556532[0], [40]);;
            addInt_301990129(result_33556532, 0, tempFrames_33556543[j_33556576].Field1);
            if (false) {
            result_33556532[0].push.apply(result_33556532[0], [44,32]);;
            addInt_301990129(result_33556532, 0, 0);
            }
            ...
            add_33556395(result_33556532, 0, tempFrames_33556543[j_33556576].Field0);
...
function rawWriteStackTrace_33556626() {
  var result_33556627 = [];
    ...
    if (!((framePtr == null))) {
    result_33556627 = nimCopy(null, ([84,114,97,99,101,98,97,99,107,32,40,109,111,115,116,32,114,101,99,101,110,116,32,99,97,108,108,32,108,97,115,116,41,10] || []).concat(auxWriteStackTrace_33556530(framePtr) || []), NTI33554449);
    }
    else {
...
function unhandledException(e_33556671) {
    ...
    buf_33556672[0].push.apply(buf_33556672[0], rawWriteStackTrace_33556626());;
...
function raiseIndexError(i_33556834, a_33556835, b_33556836) {
    ...
    Temporary1 = ([105,110,100,101,120,32] || []).concat(HEX24_369098760(i_33556834) || [],[32,110,111,116,32,105,110,32] || [],HEX24_369098760(a_33556835) || [],[32,46,46,32] || [],HEX24_369098760(b_33556836) || []);
    }
...
function nsuFindChar(s_989857469, sub_989857470, start_989857471, last_989857472) {
    var Temporary1;

  var result_989857473 = 0;
  ...
  BeforeRet: {
    ...
    F.line = 1932;
    if ((last_989857472 < 0)) {
    Temporary1 = (s_989857469).length - 1;
    }
    else {
    Temporary1 = last_989857472;
    }
    
    var last_989857474 = Temporary1;
    Label2: {
      F.line = 1935;
      var iHEX60gensym187_989857488 = 0;
      F.line = 75;
      F.filename = "iterators_1.nim";
      var colontmp__973078647 = 0;
      F.line = 1935;
      F.filename = "strutils.nim";
      colontmp__973078647 = start_989857471;
      F.line = 90;
      F.filename = "iterators_1.nim";
      ...
      Label3: {
        F.line = 91;
          Label4: while (true) {
          if (!(res_973078648 <= last_989857474)) break Label4;
            F.line = 1949;
            F.filename = "strutils.nim";
            iHEX60gensym187_989857488 = res_973078648;
            if ((s_989857469[chckIndx(iHEX60gensym187_989857488, 0, (s_989857469).length - 1)] == sub_989857470)) {
            F.line = 1937;
            result_989857473 = iHEX60gensym187_989857488;
            break BeforeRet;
            }
  ...
  return result_989857473;

}

function nsuFindStrA(a_989857447, s_989857448, sub_989857449, start_989857450, last_989857451) {
    var Temporary1;

  var result_989857452 = 0;
  ...
  BeforeRet: {
    ...
    F.filename = "strutils.nim";
    if ((last_989857451 < 0)) {
    Temporary1 = (s_989857448).length - 1;
    }
    else {
    Temporary1 = last_989857451;
    }
    
    var last_989857453 = Temporary1;
    F.line = 1892;
    var subLast_989857454 = subInt((sub_989857449).length, 1);
    if ((subLast_989857454 == -1)) {
    F.line = 1897;
    result_989857452 = start_989857450;
    break BeforeRet;
    }
    ...
    result_989857452 = -1;
    F.line = 1902;
    var skip_989857455 = start_989857450;
    Label2: {
      F.line = 1904;
        Label3: while (true) {
        if (!(subLast_989857454 <= subInt(last_989857453, skip_989857455))) break Label3;
          F.line = 1905;
          var i_989857456 = subLast_989857454;
          Label4: {
            F.line = 1906;
              Label5: while (true) {
              if (!(s_989857448[chckIndx(addInt(skip_989857455, i_989857456), 0, (s_989857448).length - 1)] == sub_989857449[chckIndx(i_989857456, 0, (sub_989857449).length - 1)])) break Label5;
                if ((i_989857456 == 0)) {
                F.line = 1908;
                result_989857452 = skip_989857455;
                break BeforeRet;
                }
                
                F.line = 1909;
                i_989857456 = subInt(i_989857456, 1);
              }
          };
          F.line = 1910;
          skip_989857455 = addInt(skip_989857455, a_989857447[chckIndx(s_989857448[chckIndx(addInt(skip_989857455, subLast_989857454), 0, (s_989857448).length - 1)], 0, (a_989857447).length - 1)]);
        }
    };
  };
  framePtr = F.prev;

  return result_989857452;

}

function fill_989857391(a_989857393, value_989857394) {
  ...
  framePtr = F;
    ...
    var xHEX60gensym183_989857400 = 0;
    Label1: {
      F.line = 98;
        Label2: while (true) {
        if (!(xHEX60gensym183_989857400 <= (a_989857393).length - 1)) break Label2;
          F.line = 98;
          a_989857393[chckIndx(xHEX60gensym183_989857400, 0, (a_989857393).length - 1)] = value_989857394;
          F.line = 75;
          xHEX60gensym183_989857400 = addInt(xHEX60gensym183_989857400, 1);
        }
    };
  framePtr = F.prev;
...
function nsuInitSkipTable(a_989857388, sub_989857389) {
  var F = {procname: "strutils.initSkipTable", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
    F.line = 1864;
    F.filename = "strutils.nim";
    var m_989857390 = (sub_989857389).length;
    F.line = 1865;
    fill_989857391(a_989857388, m_989857390);
    Label1: {
      F.line = 1867;
      var i_989857410 = 0;
      F.line = 117;
      ...
      F.line = 1867;
      F.filename = "strutils.nim";
      colontmp__973078653 = subInt(m_989857390, 1);
      F.line = 119;
      F.filename = "iterators_1.nim";
      var i_973078654 = 0;
      Label2: {
        F.line = 120;
          ...
          if (!(i_973078654 < colontmp__973078653)) break Label3;
            F.line = 1867;
            F.filename = "strutils.nim";
            i_989857410 = i_973078654;
            F.line = 1867;
            a_989857388[chckIndx(sub_989857389[chckIndx(i_989857410, 0, (sub_989857389).length - 1)], 0, (a_989857388).length - 1)] = subInt(subInt(m_989857390, 1), i_989857410);
            F.line = 122;
            F.filename = "iterators_1.nim";
...
function nsuInitNewSkipTable(sub_989857444) {
  var result_989857445 = [new Int32Array(256)];

  var F = {procname: "strutils.initSkipTable", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
    F.line = 1877;
    F.filename = "strutils.nim";
    nsuInitSkipTable(result_989857445[0], sub_989857444);
  framePtr = F.prev;

  return result_989857445[0];

}

function nsuFindStr(s_989857506, sub_989857507, start_989857508, last_989857509) {
  var result_989857510 = 0;

  var F = {procname: "strutils.find", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    if ((subInt((s_989857506).length, start_989857508) < (sub_989857507).length)) {
    F.line = 1989;
    F.filename = "strutils.nim";
    result_989857510 = -1;
    break BeforeRet;
    ...
    if (((sub_989857507).length == 1)) {
    F.line = 1990;
    result_989857510 = nsuFindChar(s_989857506, sub_989857507[chckIndx(0, 0, (sub_989857507).length - 1)], start_989857508, last_989857509);
    break BeforeRet;
    }
    
    F.line = 1993;
    result_989857510 = nsuFindStrA(nsuInitNewSkipTable(sub_989857507), s_989857506, sub_989857507, start_989857508, last_989857509);
  };
  framePtr = F.prev;

  return result_989857510;

}

function contains_989857647(s_989857648, sub_989857649) {
  var result_989857650 = false;
  ...
  BeforeRet: {
    F.line = 2147;
    F.filename = "strutils.nim";
    result_989857650 = (0 <= nsuFindStr(s_989857648, sub_989857649, 0, -1));
    break BeforeRet;
  };
  framePtr = F.prev;

  return result_989857650;
...
function HEX3Aanonymous_973078602(r_973078603) {
  ...
  BeforeRet: {
    ...
    if (!(contains_989857647(cstrToNimstr(reason_973078562.message), [102,111,111,98,97,114,58,32,55]))) {
    F.line = 249;
