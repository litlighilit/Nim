...
function reprEnum(e_33557598, typ_33557599) {
  var result_33557600 = [];
  ...
  framePtr = F;
    ...
    var tmp_33557601 = false;
    F.line = 31;
    var item_33557602 = typ_33557599.node.sons[e_33557598];
    F.line = 32;
    tmp_33557601 = item_33557602 !== undefined
    if (tmp_33557601) {
    F.line = 34;
    result_33557600 = nimCopy(null, makeNimstrLit(item_33557602.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557600 = nimCopy(null, (HEX24_369098760(e_33557598) || []).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41] || []), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557600;
